...
import { View, Text, StyleSheet, ImageBackground, Image, Alert, Dimensions, Animated } from 'react-native';
    ...
    useEffect(() => {
        ...
        if (isShaking) {
            ...
            subscription = Accelerometer.addListener(accelerometerData => {
                ...
                if (totalForce > 1.78) { // Ngưỡng để phát hiện lắc
            ...
            // Dừng lắng nghe sau 10 giây
            setTimeout(() => {
                subscription && subscription.remove();
                setIsShaking(false);
                Alert.alert('Nhận quà', 'Bạn đã lắc điện thoại thành công và nhận được quà!');
            }, 10000);
        }
            ...
            <ImageBackground source={backgroundImage} style={[styles.background, { width: screenWidth, height: screenHeight }]} resizeMode="cover">
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <CustomButton
                            title="Lắc 10 lượt"
                            onPress={() => Alert.alert('Lắc 10 lượt', 'Chức năng này chưa được triển khai')}
                            style={styles.button}
                        />
                    </View>
                </View>
