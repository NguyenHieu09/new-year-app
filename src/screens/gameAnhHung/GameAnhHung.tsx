...
const centerImage = require('../../../assets/image/tuongNha.png');
const anhHung = require('../../../assets/image/anhHung.png');

const nuoc = require('../../../assets/image/nuoc.png');
...
const GameAnhHungScreen = () => {
    ...
    const route = useRoute<RouteProp<RootStackParamList, 'GameAnhHungScreen'>>();
        ...
        <SafeAreaView style={styles.safeArea}>
            <ImageBackground source={backgroundImage} style={[styles.background, { width: screenWidth, height: screenHeight }]} resizeMode="cover">
                <View style={styles.container}>
                    ...
                    <Text style={{ fontFamily: 'Signika-Bold', fontSize: 18, marginBottom: 8, color: '#ffffff', }}>ANH HÙNG SIÊU BẢO VỆ</Text>
                    <ImageBackground source={centerImage} style={styles.frame} imageStyle={styles.frameImage}>
                        ...
                        <ImageBackground source={anhHung} style={{ width: '90%', height: "90%" }} imageStyle={{ width: '100%', height: '100%', resizeMode: 'contain', top: -50 }}>
...
export default GameAnhHungScreen;
